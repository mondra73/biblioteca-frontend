    ...
    <div
        ...
        <div class="relative z-10 w-full max-w-2xl">
            ...
            <div class="bg-card border border-border rounded-2xl shadow-lg p-8 md:p-12 text-center">
                ...
                <!-- Espacio para imagen vectorial -->
                <div class="mb-8 flex justify-center">
                    <div
                        class="w-64 h-64 bg-muted/30 rounded-2xl border-2 border-dashed border-border flex items-center justify-center">
                        <div class="text-center text-muted-foreground">
                            ...
                            <p class="text-sm">Espacio para imagen vectorial</p>
                        </div>
                    </div>
                </div>
